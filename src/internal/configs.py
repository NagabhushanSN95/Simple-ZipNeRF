...
class Config:
    ...
    test_set_num: int = None
    video_poses_num: int = 1
    video_poses_num_frames: int = 120
    scene_name: str = ''
    # exp_name: str = "test"  # experiment name
    data_dir: Optional[str] = "/SSD_DISK/datasets/360_v2/bicycle"  # Input data directory.
    vocab_tree_path: Optional[str] = None  # Path to vocab tree for COLMAP.  # TODO SNB: check if this is needed
    ...
    # NeRF Synthetic
    background_alpha_loss_name: str = None
    background_alpha_loss_mult: int = 0

    # SimpleZipNeRF
    augmentation01: bool = False
    augmentation02: bool = False
    augmentation_loss_names: Tuple[str] = (None, )
    augmentation_loss_mults: Tuple[float] = (0.0, )
    augmentation_loss_start_iter: int = 0
    augmentation_loss_rmse_threshold: float = 0.1
    augmentation_loss_patch_size: Tuple[int, int] = (5, 5)
